...
private extern (C++) final class ExpressionSemanticVisitor : Visitor
{
    ...
    override void visit(SliceExp exp)
    {
         ...
         */
        Scope* scx = sc;
        if (t1b.ty == Type.Kind.staticArray || t1b.ty == Type.Kind.array || t1b.ty == Ttuple)
        {
...
Expression semanticY(DotTemplateInstanceExp exp, Scope* sc, int flag)
{
    ...
    if (e == die)
    {
        ...
        Type t1b = exp.e1.type.toBasetype();
        if (t1b.ty == Type.Kind.array || t1b.ty == Type.Kind.staticArray || t1b.ty == Type.Kind.associativeArray || t1b.ty == Tnull || (t1b.isTypeBasic() && t1b.ty != Type.Kind.void_))
        {
