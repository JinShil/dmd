...
elem *toElem(Expression e, IRState *irs)
{
    extern (C++) class ToElemVisitor : Visitor
    {
        ...
        elem *toElemCast(CastExp ce, elem *e)
        {
            ...
            if (fty == Tvector && tty == Type.Kind.staticArray)
            {
            ...
            switch (tty)
            {
                ...
                case Tchar:     tty = Type.Kind.uint8;    break;
            ...
            switch (fty)
            {
                ...
                case Type.Kind.pointer:  fty = global.params.is64bit ? Tuns64 : Tuns32;  break;
                case Tchar:     fty = Type.Kind.uint8;    break;
        ...
        Lagain:
            switch (X(fty,tty))
            {
                ...
                case X(Tbool,Type.Kind.int8):
                case X(Tbool,Type.Kind.uint8):
                                        goto Lpaint;
                case X(Tbool,Tint16):
                case X(Tbool,Tuns16):
                case X(Tbool,Tint32):
                ...
                case X(Type.Kind.int8,Tint16):
                case X(Type.Kind.int8,Tuns16):
                case X(Type.Kind.int8,Tint32):
                case X(Type.Kind.int8,Tuns32):   eop = OPs8_16;  goto Leop;
                case X(Type.Kind.int8,Tint64):
                case X(Type.Kind.int8,Tuns64):
                case X(Type.Kind.int8,Tfloat32):
                case X(Type.Kind.int8,Tfloat64):
                case X(Type.Kind.int8,Tfloat80):
                case X(Type.Kind.int8,Tcomplex32):
                case X(Type.Kind.int8,Tcomplex64):
                case X(Type.Kind.int8,Tcomplex80):
                                        e = el_una(OPs8_16, TYint, e);
                                        fty = Tint32;
                                        goto Lagain;
                case X(Type.Kind.int8,Timaginary32):
                case X(Type.Kind.int8,Timaginary64):
                case X(Type.Kind.int8,Timaginary80): goto Lzero;

                /* ============================= */

                case X(Type.Kind.uint8,Type.Kind.int8):    goto Lpaint;
                case X(Type.Kind.uint8,Tint16):
                case X(Type.Kind.uint8,Tuns16):
                case X(Type.Kind.uint8,Tint32):
                case X(Type.Kind.uint8,Tuns32):   eop = OPu8_16;  goto Leop;
                case X(Type.Kind.uint8,Tint64):
                case X(Type.Kind.uint8,Tuns64):
                case X(Type.Kind.uint8,Tfloat32):
                case X(Type.Kind.uint8,Tfloat64):
                case X(Type.Kind.uint8,Tfloat80):
                case X(Type.Kind.uint8,Tcomplex32):
                case X(Type.Kind.uint8,Tcomplex64):
                case X(Type.Kind.uint8,Tcomplex80):
                                        e = el_una(OPu8_16, TYuint, e);
                                        fty = Tuns32;
                                        goto Lagain;
                case X(Type.Kind.uint8,Timaginary32):
                case X(Type.Kind.uint8,Timaginary64):
                case X(Type.Kind.uint8,Timaginary80): goto Lzero;

                /* ============================= */

                case X(Tint16,Type.Kind.int8):
                case X(Tint16,Type.Kind.uint8):   eop = OP16_8;   goto Leop;
                ...
                case X(Tuns16,Type.Kind.int8):
                case X(Tuns16,Type.Kind.uint8):   eop = OP16_8;   goto Leop;
                ...
                case X(Tint32,Type.Kind.int8):
                case X(Tint32,Type.Kind.uint8):   e = el_una(OP32_16, TYshort, e);
                                        fty = Tint16;
                                        goto Lagain;
                ...
                case X(Tuns32,Type.Kind.int8):
                case X(Tuns32,Type.Kind.uint8):   e = el_una(OP32_16, TYshort, e);
                                        fty = Tuns16;
                                        goto Lagain;
                ...
                case X(Tint64,Type.Kind.int8):
                case X(Tint64,Type.Kind.uint8):
                ...
                case X(Tuns64,Type.Kind.int8):
                case X(Tuns64,Type.Kind.uint8):
                ...
                case X(Tfloat32,Type.Kind.int8):
                case X(Tfloat32,Type.Kind.uint8):
                ...
                case X(Tfloat64,Type.Kind.int8):
                case X(Tfloat64,Type.Kind.uint8):    e = el_una(OPd_s16, TYshort, e);
                                           fty = Tint16;
                                           goto Lagain;
                ...
                case X(Tfloat80,Type.Kind.int8):
                case X(Tfloat80,Type.Kind.uint8):
                ...
                case X(Timaginary32,Type.Kind.int8):
                case X(Timaginary32,Type.Kind.uint8):
                ...
                case X(Timaginary64,Type.Kind.int8):
                case X(Timaginary64,Type.Kind.uint8):
                ...
                case X(Timaginary80,Type.Kind.int8):
                case X(Timaginary80,Type.Kind.uint8):
                ...
                case X(Tcomplex32,Type.Kind.int8):
                case X(Tcomplex32,Type.Kind.uint8):
                ...
                case X(Tcomplex64,Type.Kind.int8):
                case X(Tcomplex64,Type.Kind.uint8):
                ...
                case X(Tcomplex80,Type.Kind.int8):
                case X(Tcomplex80,Type.Kind.uint8):
